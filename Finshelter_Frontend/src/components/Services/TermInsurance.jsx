...
const TermInsurancePage = () => {
	...
	const SERVICE_ID = "SER109"; // Replace with your actual service ID for insurance
		...
		const fetchServiceData = async () => {
			try {
				...
				const response = await axios.get(
					`http://localhost:8000/api/customers/user-services/${SERVICE_ID}`
				);
							...
							<Grid
								...
								<HeroContent>
									...
									<Typography
										...
										{service?.serviceName || "Term Insurance"}
									</Typography>
									<Typography
										variant='h4'
										color='primary'
				...
				<Container maxWidth='xl' sx={{ py: { xs: 4, md: 8 } }}>
					<Grid container spacing={4}>
						...
						<Grid item xs={12} md={9} lg={9.5}>
									...
									<Grid container spacing={3}>
										<Grid item xs={12} md={7}>
											<Typography
												...
												have to be. At FinShelter, we provide comprehensive life
												insurance solutions tailored to your unique needs,
												ensuring financial security and peace of mind for you
												and your loved ones.
											</Typography>
											<Typography
												variant='body1'
												paragraph
												sx={{ fontSize: "1.05rem", lineHeight: 1.7 }}>
												The primary purpose of term life insurance is to provide
												financial security to your dependents if you're no
												longer around to support them. The payout can help cover
												various expenses such as mortgage or rent payments, debt
												repayment, children's education, and daily living
												expenses.
											</Typography>
											<Typography
												variant='body1'
												paragraph
												sx={{ fontSize: "1.05rem", lineHeight: 1.7 }}>
												At FinShelter, we believe that life insurance is more
												than just a policy—it's a commitment to your loved ones.
												Whether it's ensuring financial security, supporting
												life goals, or providing long-term stability, our life
												insurance solutions are designed to help you face the
											...
											<Box
												...
												<List sx={{ pl: 1, position: "relative", zIndex: 1 }}>
													{[
														...
														"High coverage amount for your family's security",
														"Tax benefits under Section 80C",
														"Simple and straightforward policy terms",
							...
							{/* Why Choose Life Insurance Section - NEW */}
										...
										{[
											{
												...
												description:
													"Life insurance ensures that your family's day-to-day needs, such as housing, education, and medical expenses, are met without disruption even in your absence.",
												icon: (
													<HomeIcon
											...
											{
												title: "Protect Against Debt",
												description:
													"Outstanding loans and liabilities, such as home loans, personal loans, or business debts, are cleared, lifting financial burdens from your loved ones.",
												icon: (
											...
											{
												title: "Support Life Goals",
												description:
													"Be it funding your child's higher education, planning for a wedding, or pursuing long-term savings goals, life insurance offers both protection and financial growth.",
												icon: (
													<SavingsIcon
														sx={{ fontSize: 36, color: "primary.main" }}
													/>
											...
											},
											{
												...
												description:
													"Beyond securing immediate financial needs, life insurance allows you to leave a lasting legacy for your family, giving them security and opportunities for the future.",
												icon: (
													<FamilyRestroomIcon
														sx={{ fontSize: 36, color: "primary.main" }}
													/>
										...
										{[
											{
												...
												description:
													"An economical solution offering high coverage for a specified period, ensuring your family's protection during critical years.",
												icon: <SecurityIcon />,
											},
											{
												title: "Whole Life Insurance",
												description:
													"Provides lifelong financial security while accumulating cash savings over time, which can be accessed when needed.",
												icon: <HistoryIcon />,
											},
											{
												title: "Endowment Plans",
												description:
													"A hybrid plan that combines life insurance with savings, enabling you to meet key financial milestones, such as buying a home or retiring comfortably.",
												icon: <AccountBalanceIcon />,
											},
											{
												title: "ULIPs",
												description:
													"Offers dual benefits of life coverage and investment opportunities, helping grow your wealth in addition to providing insurance.",
												icon: <AssessmentIcon />,
											},
											{
												title: "Child Plans",
												description:
													"These plans focus on safeguarding your child's future, ensuring funds are available for their education or other essential needs, even in unforeseen circumstances.",
												icon: <FamilyRestroomIcon />,
											},
											{
												title: "Retirement Plans",
												description:
													"Guarantees steady income post-retirement, allowing you to enjoy a financially secure and stress-free life during your golden years.",
												icon: <SavingsIcon />,
											},
										].map((offering, index) => (
											<Grid
										...
										<Grid item xs={12} md={6}>
											<Box
												...
												<Typography
													...
													paragraph
													sx={{ fontSize: "1.05rem", lineHeight: 1.7 }}>
													At FinShelter, we prioritize your peace of mind and
													your family's well-being. Our team of seasoned
													professionals analyzes your financial situation and
													goals to recommend the most suitable life insurance
													plans. We understand that every family has unique
													needs, and we offer plans that align perfectly with
													your specific requirements and life goals.
												</Typography>
												...
												<Typography
													...
													We maintain full transparency throughout the process,
													ensuring you understand every aspect of your policy,
													from benefits and premium terms to claim procedures.
													Our commitment to your family's security extends
													beyond just selling a policy - we're here to support
													...
													{[
														{
															title: "Expert Advice",
															description:
																"With a team of seasoned professionals, we analyze your financial situation and goals to recommend the most suitable life insurance plans.",
														},
														{
															title: "Customized Solutions",
															description:
																"Every family has unique needs, and we offer plans that align perfectly with your specific requirements and life goals.",
														},
														{
															title: "Transparent Process",
															description:
																"We maintain full transparency, ensuring you understand every aspect of your policy, from benefits and premium terms to claim procedures.",
														},
														{
															title: "Effortless Experience",
															description:
																"Our team takes care of the entire process, including consultations, paperwork, and support, making it stress-free for you.",
														},
														{
															title: "Ongoing Support",
															description:
																"Even after you purchase a policy, we're here to guide you, assist with claims, and provide updates on policy enhancements to meet changing needs.",
														},
													].map((item, index) => (
														<ListItem
															key={index}
							...
							<section ref={packagesRef} id='packages'>
								<SectionBox id='packages-section'>
									...
									<Typography
										...
										Choose the right coverage to safeguard your family's
										financial future. Our term insurance plans offer
										comprehensive protection at affordable rates.
									</Typography>
														...
														<CardContent sx={{ p: { xs: 2.5, md: 3 } }}>
															...
															<Box
																...
																<Typography
																	...
																	₹{pkg.salePrice.toLocaleString("en-IN")}
																	<Typography
																		component='span'
																		variant='subtitle2'
																		color='text.secondary'
														...
														<CardActions sx={{ px: 3, pb: { xs: 4, md: 3 } }}>
															<Button
																...
																sx={{
																	...
																	fontWeight: 600,
																	boxShadow:
																		"0 4px 10px rgba(27, 50, 29, 0.25)",
																	"&:hover": {
																		transform: "translateY(-2px)",
																		boxShadow:
																			"0 6px 12px rgba(27, 50, 29, 0.3)",
																	},
																}}>
																Select Package
															</Button>
