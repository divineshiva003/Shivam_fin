...
const CreditCardPage = () => {
	...
	const defaultLoanProducts = [
		{
			...
			description:
				"Earn cashback on everyday purchases, utility payments, and online shopping.",
			icon: <MoneyIcon fontSize='large' />,
		},
		{
			title: "Rewards Credit Card",
			description:
				"Get rewarded with points on your spends, redeemable for travel, merchandise, or discounts.",
			icon: <GroupIcon fontSize='large' />,
		},
		{
			title: "Travel Credit Card",
			description:
				"Enjoy perks like free lounge access, air miles, and exclusive travel discounts.",
			icon: <SavingsIcon fontSize='large' />,
		},
		{
			title: "Fuel Credit Card",
			description:
				"Save on fuel costs with surcharge waivers and additional rewards on fuel transactions.",
			icon: <AutoGraphIcon fontSize='large' />,
		},
		{
			title: "Lifestyle Credit Card",
			description:
				"Access premium lifestyle benefits, including dining offers, shopping rewards, and concierge services.",
			icon: <MoneyIcon fontSize='large' />,
		},
		{
			title: "Business Credit Card",
			description:
				"Tailored for businesses, offering higher credit limits, expense tracking, and exclusive perks.",
			icon: <DescriptionIcon fontSize='large' />,
		},
		{
			title: "Student Credit Card",
			description:
				"Designed for students with low or no-income, offering minimal fees and introductory benefits.",
			icon: <GroupIcon fontSize='large' />,
		},
		{
			title: "Premium/Platinum Credit Card",
			description:
				"Aimed at high-income individuals, offering elite benefits such as higher credit limits, exclusive memberships, and luxury rewards.",
	...
	const defaultLoanFeatures = [
		{
			...
			description:
				"Make payments securely across millions of merchants worldwide.",
			icon: <AccessTimeIcon fontSize='large' />,
		},
		{
			title: "Reward Points System",
			description:
				"Earn points on every transaction and redeem them for exciting rewards or discounts.",
			icon: <MoneyIcon fontSize='large' />,
		},
		{
			title: "Cashback Offers",
			description:
				"Save more with attractive cashback on online shopping, fuel, dining, and more.",
			icon: <AccountBalanceIcon fontSize='large' />,
		},
		{
			title: "Zero Annual Fee Options",
			description:
				"Select credit cards with no annual charges to keep costs low.",
			icon: <DescriptionIcon fontSize='large' />,
		},
		{
			title: "Interest-Free Credit Period",
			description:
				"Enjoy up to 45–50 days of interest-free credit, depending on the card.",
			icon: <DescriptionIcon fontSize='large' />,
		},
		{
			title: "Contactless Transactions",
			description:
				"Tap and pay securely for small transactions without the need for a PIN.",
			icon: <DescriptionIcon fontSize='large' />,
		},
		{
			title: "EMI Conversion",
			description:
				"Easily convert large purchases into affordable monthly installments.",
			icon: <DescriptionIcon fontSize='large' />,
		},
		{
			title: "Exclusive Perks",
			description:
				"Access offers such as complimentary airport lounge access, dining privileges, and shopping discounts.",
			icon: <DescriptionIcon fontSize='large' />,
		},
		{
			title: "24/7 Customer Support",
			description:
				"Get round-the-clock assistance for all your credit card-related queries.",
			icon: <DescriptionIcon fontSize='large' />,
		},
	];
	...
	const defaultFaqs = [
		{
			question: "How do I apply for a FinShelter credit card?",
			answer:
				"You can apply online through our website or visit the nearest FinShelter branch. Our representatives will assist you with the process.",
		},
		{
			question: "What documents are required for a credit card application?",
			answer:
				"You'll need identity proof, address proof, and income proof, such as salary slips, ITRs, or bank statements.",
		},
		{
			question: "Can I use my credit card internationally?",
			answer:
				"Yes, FinShelter credit cards are globally accepted at millions of merchants for both online and offline transactions.",
		},
		{
			question: "What happens if I miss a credit card payment?",
			answer:
				"Missing payments may result in late payment charges and interest on the outstanding balance. It may also impact your credit score.",
		},
		{
			question: "How can I earn rewards on my credit card?",
			answer:
				"Rewards are earned on every eligible transaction and can be redeemed for travel, shopping, or discounts through our rewards program.",
		},
		{
			question: "Can I convert my credit card purchases into EMIs?",
			answer:
				"Yes, FinShelter offers the option to convert large transactions into affordable monthly instalments.",
		},
		{
			question: "Is there a joining fee or annual fee?",
			answer:
				"We offer both fee-free and premium credit card options. Fees (if any) are transparently communicated during the application process.",
		},
	];
						...
						<Box
							...
							<HeroPaper
								...
								<Box sx={{ flex: 1, textAlign: { xs: "center", md: "left" } }}>
									<Typography
										...
										{service?.serviceName || "Credit Card"}
									</Typography>
								</Box>
							...
							<Box
								...
								<StyledTabs
									...
									<StyledTab label='TYPES OF CARDS' />
							...
							{service?.longDescription?.map((para, index) => (
								...
								<>
									<Typography
										...
										purchases or pay for services by borrowing funds within a
										pre-approved credit limit. It offers unmatched convenience,
										enabling you to shop, dine, travel, or even manage
										unforeseen expenses with ease. At FinShelter, our credit
										cards are tailored to meet the diverse needs of customers,
										providing rewards, flexibility, and secure transactions.
									</Typography>
									<Typography
										variant='body1'
										paragraph
								...
								service?.eligibilityCriteria || [
									{
										title: "Age",
										description:
											"<p>Minimum age: 18 years</p><p>Maximum age: 60 years for salaried individuals, 65 years for self-employed applicants.</p>",
									},
									{
										title: "Income Criteria",
										description:
											"<p>Salaried applicants must meet the minimum monthly income requirement (varies based on card type).</p><p>Self-employed applicants should provide proof of consistent annual income.</p>",
									},
									{
										title: "Credit Score",
										description:
											"<p>A credit score of 700 or above improves eligibility and ensures access to premium cards.</p>",
									},
									{
										title: "Employment Status",
										description:
											"<p>Salaried individuals should have at least 6 months of work experience.</p><p>Self-employed applicants should have a stable business track record of at least 2 years.</p>",
									},
								]
							).map((criteria, index) => (
