      ...
      <div className="policy-content">
        <div className="policy-section">
          <p>
            ...
            agreement by and between FinShelter, ("we" or "us" or "our") and you ("you" or "your") and relate to your use of our website, goods (as applicable), or services (as applicable) (collectively, "Services").
          </p>
          ...
          <ul className="terms-list">
            ...
            <li>
              You shall be entitled to claim a refund of the payment made by you in case we are not able to provide the Service. The timelines for such returns and refunds will be according to the specific service you have availed or within the time period provided in our policies (as applicable). In case you do not raise a refund claim within the stipulated time, then this would make you ineligible for a refund.
            </li>
            <li>
